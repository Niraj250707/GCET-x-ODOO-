      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Streamline your HR processes with our all-in-one platform. 
            Attendance, leaves, payroll, and community — all in one place.
          </p>
          ...
          <div className="flex gap-8 mt-12">
            ...
            <div>
              <p className="text-4xl font-bold font-display">99%</p>
              ...
              <div className="flex gap-6">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-primary focus:ring-primary"
                  />
                  <span className="text-sm">Admin / HR Manager</span>
                </label>
              </div>
            </div>
